  ...
  return (
    <div className="flex flex-col gap-[1.5rem] md:flex-row md:items-end">
      ...
      <div className="flex flex-col gap-[1rem] px-[1rem]">
        <p className="text-start text-[1.125rem] font-bold uppercase leading-[1.25] -tracking-[1px] text-[#fffffa]">
          {title}
        </p>
        <p className="text-start font-normal leading-[1.5] -tracking-[0.5px] text-[#fffffa]">
          {description}
        </p>
